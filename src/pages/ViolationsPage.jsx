...
import { getViolations, saveViolation, deleteViolation, bulkImportViolations } from "../lib/store.js";
...
const CSV_FIELDS = [
  { key: "name",        label: "Violation Name", required: true },
  { key: "code",        label: "Code / Short Ref" },
  { key: "statute",     label: "Statute", required: true },
  { key: "description", label: "Description" },
  { key: "category",    label: "Category" },
  { key: "cv071Field",  label: "CV-071 Checkbox Field" },
  { key: "js44Field",   label: "JS44 Checkbox Field" },
];
...
export default function ViolationsPage() {
  return (
    <LibraryPage
      ...
      loadItems={getViolations}
      onSave={saveViolation}
      onDelete={deleteViolation}
      onBulkImport={bulkImportViolations}
